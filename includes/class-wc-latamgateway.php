...
if ( ! class_exists( 'Wc_LatamGateway' ) ) {
	...
	final class Wc_LatamGateway {
		...
		if ( is_admin() )
			add_action( 'admin_notices', [__CLASS__, 'plugins_missing_notice'] );
			add_action( 'admin_notices', [__CLASS__, 'credentials_missing_notice'] );
			add_action( 'admin_notices', [__CLASS__, 'currency_not_supported_notice'] );
		}
