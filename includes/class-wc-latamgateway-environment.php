...
if ( ! class_exists( 'Wc_LatamGateway_Environment' ) ) {
	 ...
	 */
	class Wc_LatamGateway_Environment {
		/**
		 * The PHP version.
		 *
		 * @access   private
		...
		$this->_woocommerce_version = Wc_LatamGateway_Helper::woocommerce_version();
		...
		$all_active_plugins = Wc_LatamGateway_Helper::wordpress_plugins();
